...
[رادیو فول‌استک SokanAcademy](https://sokanacademy.com/podcast) | رادیو فول‌استک سکان آکادمی، به ارائه‌ٔ مصاحبه‌های پادکستی در حوزه‌های برنامه‌نویسی، شبکه، هوش مصنوعی، طراحی سایت، استارتاپ و کارآفرینی و غیره با فعالان آی‌تی می‌پردازد.
...
[آواهای کم‌شنیده از دیروز تا امروز](http://www.dastan118.ir/) | بی‌پلاس یک پادکست فارسی است که در هر اپیزودش ما خلاصه‌ی یک کتاب غیرداستانی را به فارسی تعریف می‌کنیم.
